...
let ApplicationsController = class ApplicationsController {
    ...
    findApplicationsForJob(jobId, req) {
...
__decorate([
    (0, roles_decorator_1.Roles)(user_entity_1.Role.CANDIDATE),
...
__decorate([
    (0, roles_decorator_1.Roles)(user_entity_1.Role.CANDIDATE),
    (0, common_1.Get)('my'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all applications submitted by current candidate' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all applications for a specific job (Employer only)' }),
    __param(0, (0, common_1.Param)('jobId')),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], ApplicationsController.prototype, "findApplicationsForJob", null);
__decorate([
    (0, roles_decorator_1.Roles)(user_entity_1.Role.EMPLOYER),
